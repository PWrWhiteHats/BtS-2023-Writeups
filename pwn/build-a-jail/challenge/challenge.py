...
def main():
    # this is a hack to force use of /dev/shm/ to store tempfile
    # because default locations used by python's tempdir are read-only
    with TemporaryDirectory(prefix="/dev/shm/temp_") as dir:
        chdir(dir)
